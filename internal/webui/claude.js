...
function render() {
  ...
  $("cost-economics").innerHTML=TraceEconomics.spendHTML(s,undefined,state.sessions.flatMap(session=>session.prices||[]));
  renderChart();
  renderSessions();
  renderInspector();
  renderSources();
