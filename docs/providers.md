...
- **Claude Code / Codex:** native session logs can contain cumulative snapshots and repeated events. No native importer is shipped yet. Do not rename cumulative totals as request usage.
